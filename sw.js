...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-1dfe8d","is-html-1dfe8d","is-jsdelivr-1dfe8d","is-gtm-1dfe8d","is-gravatar-1dfe8d","is-theme-1dfe8d","is-cdn-1dfe8d","is-json-1dfe8d"];
      return Promise.all(
        names
